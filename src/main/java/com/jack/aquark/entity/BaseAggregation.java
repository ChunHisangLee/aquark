...
/**
 * Common fields for DailyAggregation and HourlyAggregation.
 * MappedSuperclass means these fields map to columns in child entities,
 * but there's no separate 'base_aggregation' table.
 */
@MappedSuperclass
@Getter
@Setter
